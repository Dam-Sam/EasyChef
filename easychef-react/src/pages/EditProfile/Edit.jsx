        ...
        <Col md={6} className="signup-right">
          <Form>
            <Row>
              <Col md={6}>
                <Form.Group controlId="formBasicFirstName">
                  ...
                  <Form.Control type="text" placeholder="Enter First Name" value={first_name} onChange={handleFirstName} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group controlId="formBasicLastName">
                  <Form.Label>Last Name</Form.Label>
                  <Form.Control type="text" placeholder="Enter Last Name" value={last_name} onChange={handleLastName} />
                </Form.Group>
              </Col>
            </Row>
            ...
            <Form.Group controlId="formBasicUsername">
              ...
              <Form.Control type="text" placeholder="Enter username" value={username} required={true} onChange={handleUsername} />
            </Form.Group>
            <Form.Group controlId="formBasicEmail">
              <Form.Label>Email address</Form.Label>
              <Form.Control type="email" placeholder="Enter email" value={email} required={true} onChange={handleEmail} />
            </Form.Group>
            <Form.Group controlId="formBasicPhoneNumber">
              <Form.Label>Phone Number</Form.Label>
              <Form.Control type="tel" placeholder="Enter Phone Number" value={phone_number} onChange={handlePhone} />
            </Form.Group>
